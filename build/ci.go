...
func doArchive(cmdline []string) {
	var (
		...
		signer = flag.String("signer", "", `Environment variable holding the signing key (e.g. PPA_SIGNING_KEY)`)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/akroma-project/akroma/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/akroma-project/akroma/mobile")
